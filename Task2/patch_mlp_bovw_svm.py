...
roc_curve(test_visual_words, test_labels, classifier, RESULTS+'ROC_bow.png')

accuracy = classifier.score(test_visual_words, test_labels)

print(f'Test accuracy: {accuracy}')

display_multilabel_confusion_matrix(test_visual_words, test_labels, classifier, RESULTS+'confusion_matrix_box.png')
