...
DATASET_DIR = '/ghome/mcv/datasets/C3/MIT_small_train_3'
IMG_WIDTH = 224
IMG_HEIGHT=224
BATCH_SIZE=32
NUMBER_OF_EPOCHS=20
...
if True:
    ...
    plt.savefig('tmp_results/accuracy_train3_frozen.jpg')
    plt.close()
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    plt.savefig('tmp_results/loss_train3_frozen.jpg')
    plt.close()
...
if True:
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    plt.savefig('tmp_results/accuracy_train3.jpg')
    plt.close()
    # summarize history for loss
    plt.plot(history.history['loss'])
    plt.plot(history.history['val_loss'])
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    plt.savefig('tmp_results/loss_train3.jpg')
    plt.close()