...
MODEL_FNAME_FROZEN = f'/ghome/group01/group01/project23-24-01/Task3/weights/CPU/{NUMBER_OF_EPOCHS}_xception_frozen.weights.h5'
...
if True:
    ...
    plt.savefig(f'results/CPU/{NUMBER_OF_EPOCHS}_accuracy_train1_frozen.jpg')
    plt.close()
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    plt.savefig(f'results/CPU/{NUMBER_OF_EPOCHS}_loss_train1_frozen.jpg')
    plt.close()
...
if True:
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    plt.savefig(f'results/CPU/{NUMBER_OF_EPOCHS}_accuracy_train1.jpg')
    plt.close()
    # summarize history for loss
    plt.plot(history.history['loss'])
    plt.plot(history.history['val_loss'])
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    plt.savefig(f'results/CPU/{NUMBER_OF_EPOCHS}_loss_train1.jpg')
    plt.close()