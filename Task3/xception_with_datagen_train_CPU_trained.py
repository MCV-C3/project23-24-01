...
NUM_CLASSES=8
MODEL_FNAME = f'/ghome/group01/group01/project23-24-01/Task3/weights/CPU/{NUMBER_OF_EPOCHS}_xception.weights.h5'
MODEL_FNAME_FROZEN = f'/ghome/group01/group01/project23-24-01/Task3/weights/CPU/{NUMBER_OF_EPOCHS}_xception_frozen_augmented.weights.h5'
...
train_data_generator = tf.keras.preprocessing.image.ImageDataGenerator(
    ...
    rotation_range=30,  # rotation_range: Randomly rotate images by a specified degree.
    width_shift_range=0.4,  # width_shift_range: Randomly shift the width of images.
    height_shift_range=0.4,  # height_shift_range: Randomly shift the height of images.
    zoom_range=0.6,  # zoom_range: Randomly zoom into images.
...
if True:
    ...
    plt.savefig(f'results/CPU/{NUMBER_OF_EPOCHS}_accuracy_train1_augmentation.jpg')
    plt.close()
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    plt.savefig(f'results/CPU/{NUMBER_OF_EPOCHS}_loss_train1_augmentation.jpg')
    plt.close()